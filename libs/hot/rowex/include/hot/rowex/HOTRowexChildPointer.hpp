    ...
    case hot::commons::NodeType::MULTI_MASK_8_BYTES_AND_8_BIT_PARTIAL_KEYS:
      return operation(
          *castToNode<hot::commons::NodeType::
                          MULTI_MASK_8_BYTES_AND_8_BIT_PARTIAL_KEYS>(node));
...
inline HOTRowexChildPointer &HOTRowexChildPointer::operator=(
    const HOTRowexChildPointer &other) {
...
inline bool HOTRowexChildPointer::operator==(
    HOTRowexChildPointer const &other) const {
...
inline HOTRowexChildPointer const *HOTRowexChildPointer::search(
    uint8_t const *const &keyBytes) const {
...
inline HOTRowexChildPointer HOTRowexChildPointer::getLargestLeafValueInSubtree()
    const {
  return isLeaf() ? *this
                  : getNode()
